...
def sql_chain(question):
    ...
    # using REGEX processing llm generated sql_query to get pure sql query that can be run on the .sqlite database
    pattern = "<SQL>(.*?)</SQL>"
    ...
    print (f"Pure SQL Query: {matches[0].strip()}")
    ...
    # giving question asked and data relevant to the answer to llm to give human read-able answer
...
# C:\Aarish_Personal\e-Commerce-Chat-Bot\app\resources
